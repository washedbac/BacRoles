...
namespace TownOfUs.CrewmateRoles.AdvengerMod
{
    ...
    public class CantReport
    {
        public static void Postfix(PlayerControl __instance)
        {
            ...
            if (!__instance.Is(RoleEnum.Advenger)) return;
            if (CustomGameOptions.AdvengerBodyReport) return;
    ...
    public static class DontReport
    {
        ...
        {
            if (!__instance.Is(RoleEnum.Advenger)) return true;
            if (CustomGameOptions.AdvengerBodyReport) return true;
