    ...
    public class Doomsayer : Role, IGuesser
    {
        ...
        public Doomsayer(PlayerControl player) : base(player)
        {
            ...
            if (CustomGameOptions.GameMode == GameMode.Classic || CustomGameOptions.GameMode == GameMode.AllAny)
            {
                ...
                if (CustomGameOptions.AdvengerOn > 0 || (CustomGameOptions.VampireHunterOn > 0 && CustomGameOptions.GameMode == GameMode.Classic && CustomGameOptions.VampireOn > 0 && CustomGameOptions.BecomeOnVampDeaths == BecomeEnum.Sheriff)) ColorMapping.Add("Sheriff", Colors.Advenger);
