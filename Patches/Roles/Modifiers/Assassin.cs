...
namespace TownOfUs.Roles.Modifiers
{
    public class Assassin : Ability, IGuesser
    {
        ...
        public Assassin(PlayerControl player) : base(player)
        {
            ...
            if (CustomGameOptions.AdvengerOn > 0 || (CustomGameOptions.VampireHunterOn > 0 && CustomGameOptions.GameMode == GameMode.Classic && CustomGameOptions.VampireOn > 0 && CustomGameOptions.BecomeOnVampDeaths == BecomeEnum.Sheriff)) ColorMapping.Add("Advenger", Colors.Advenger);
