...
namespace TownOfUs
{
    public static class RpcHandling
    {
        ...
        private static void GenEachRoleKilling(List<GameData.PlayerInfo> infected)
        {
            ...
            {
                var Advenger = crewmates.Count - NeutralKillingRoles.Count - CrewmateRoles.Count;
                while (Advenger > 0)
                {
                    CrewmateRoles.Add((typeof(Advenger), 10, false));
                    Advenger -= 1;
                }
            }
        ...
        private static void GenEachRoleCultist(List<GameData.PlayerInfo> infected)
        {
            ...
            if (CustomGameOptions.SheriffCultistOn > 0) specialRoles.Add((typeof(Advenger), CustomGameOptions.SheriffCultistOn, true));
            ...
            public static void Postfix()
            {
                ...
                if (CustomGameOptions.GameMode == GameMode.Classic || CustomGameOptions.GameMode == GameMode.AllAny)
                {
                    ...
                    if (CustomGameOptions.MayorOn > 0)
                        CrewmateRoles.Add((typeof(Mayor), CustomGameOptions.MayorOn, false));

                    if (CustomGameOptions.AdvengerOn > 0)
                        CrewmateRoles.Add((typeof(Advenger), CustomGameOptions.AdvengerOn, true));
                    ...
                    if (CustomGameOptions.SwapperOn > 0)
                        CrewmateRoles.Add((typeof(Swapper), CustomGameOptions.SwapperOn, false));

                    if (CustomGameOptions.InvestigatorOn > 0)
                        CrewmateRoles.Add((typeof(Investigator), CustomGameOptions.InvestigatorOn, false));

                    if (CustomGameOptions.MedicOn > 0)
                        CrewmateRoles.Add((typeof(Medic), CustomGameOptions.MedicOn, false));
                    ...
                    if (CustomGameOptions.AltruistOn > 0)
                        CrewmateRoles.Add((typeof(Altruist), CustomGameOptions.AltruistOn, false));
                    ...
                    if (CustomGameOptions.ImitatorOn > 0)
                        CrewmateRoles.Add((typeof(Imitator), CustomGameOptions.ImitatorOn, false));

                    if (CustomGameOptions.ProsecutorOn > 0)
                        CrewmateRoles.Add((typeof(Prosecutor), CustomGameOptions.ProsecutorOn, false));

                    if (CustomGameOptions.OracleOn > 0)
                        CrewmateRoles.Add((typeof(Oracle), CustomGameOptions.OracleOn, false));
